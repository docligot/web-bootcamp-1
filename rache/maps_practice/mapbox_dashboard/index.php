...
<body>
  ...
  <div id="map"></div>
  <!-- ABOUT -->
	<section id="id01" class="w3-modal w3-card" style="display: block;">
        <div class="w3-modal-content w3-animate-zoom">
            <div>
                <div class= "body w3-dark-grey w3-bar">
                    <div class="w3-padding w3-bar-item"><i class="fa fa-info-circle"></i>&nbsp; About </div>
                    <div onclick="toggle('id01');" class="w3-bar-item w3-button w3-right w3-hover-none">Close &times;</div>
                </div>
                <div class="w3-padding w3-light-grey">
                    <div class="w3-row w3-roboto-body">
										<div id="modalTitle" class="w3-center"> GeoMapping Viz</div>
										<p>GeoMapping Viz is a dashboard for visualizing georeferenced data from various sources such as earth observations and other official publicly released datasets.</p>
                    </div>
                </div>
        </div>
		</section>
  <div class ="w3-row">
      ...
      <!-- Basemap Style Dropdown -->
       <div class="w3-dropdown-click" style="top:270px;left: 102px;">
      ...
      <!-- Zoom level Dropdown -->
      <div class="w3-dropdown-click" style="top:310px;left: 68px;">
 ...
 <footer id="footer" class="w3-bottom w3-bar w3-padding" style="z-index: 2;">&copy; 2020 Cirrolytix Research Services</footer>
