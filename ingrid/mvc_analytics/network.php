...
<div class="w3-row">
	<div class="w3-quarter">
		<select class="w3-select w3-light-grey" onchange="getNode(this.value);">
			<option value="">Select Staff</option>
			<option value=1>Doc</option>
			<option value=2>Claire</option>
			<option value=3>Mark</option>
			<option value=4>Sam</option>
			<option value=5>Nick</option>
			<option value=6>Cricket</option>
			<option value=6>Oscar</option>
			<option value=6>Helen</option>
			<option value=6>Tessa</option>
			<option value=6>Kristel</option>
			<option value=6>Ems</option>
			<option value=6>Ingrid</option>
		</select>
